...
class _View extends StatelessWidget {
  ...
  const _View({Key? key, required this.graphData}) : super(key: key);
      ...
      child: Zoom(
        ...
        child: gv.GraphView(
          ...
          builder: (node) {
            ...
            return Container(
              width: 50 + 20 * (controller.maxDistance - nodeDetails.distance),
              height: 50 + 20 * (controller.maxDistance - nodeDetails.distance),
